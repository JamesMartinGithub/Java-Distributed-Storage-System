public class Protocol {
	...
	public final static String LIST_TOKEN = "LIST"; // also from Controller (LIST - request to controller) and Dstores (LIST file_list - response to controller)
	...
	public final static String REMOVE_TOKEN = "REMOVE"; // also from Controller (REMOVE filename - request to dstore)
	...
	public final static String ERROR_FILE_DOES_NOT_EXIST_TOKEN = "ERROR_FILE_DOES_NOT_EXIST"; // also from Dstores (response to controller)
