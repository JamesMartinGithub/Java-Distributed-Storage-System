...
public class ClientMain {
	...
	public static void main(String[] args) throws Exception{
		...
		customClientTest(cport, timeout, downloadFolder, uploadFolder);
	...
	public static void customClientTest(int cport, int timeout, File downloadFolder, File uploadFolder) {
		Client client = null;
		try {
